...
| Pin 9 | GPIO 33 |I/O|  Contôle du moteur gauche  | `MS3_D` |
| Pin 10 | GPIO 25 |I/O|  Contôle du moteur gauche  | `MS2_D` |
| Pin 11 | GPIO 26 |I/O|  Contôle du moteur gauche  | `MS1_D` |
| Pin 12 | GPIO 27 |I/O|  Contôle du moteur gauche  | `STEP_D` |
| Pin 13 | GPIO 14 |I/O|  Contôle du moteur droit  | `STEP_G` |  |  |
| Pin 14 | GPIO 12 |I/O|  Réservée |  | Configuration de la tension d'alimentation | X |
| Pin 15 | N/A |P|  Alimentation | `GND` | | |
| Pin 16 | GPIO 13 |I/O|  Contôle du moteur droit | `MS3_G` | |  |
...
| Pin 23 | GPIO 15 |I/O|  Contôle du moteur droit  | `MS2_G` |  | X |
| Pin 24 | GPIO 2 |I/O|   Contôle du moteur droit  | `MS1_G` |  | X |
